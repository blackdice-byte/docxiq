...
const ConversionResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class ConversionResult {
     ...
     */
    get error() {
        const ret = wasm.conversionresult_error(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
    ...
    get output() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.conversionresult_output(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get success() {
        const ret = wasm.conversionresult_success(this.__wbg_ptr);
        return ret !== 0;
    }
}
 ...
 * @returns {any}
 */
export function batch_markdown_to_html(documents) {
    const ret = wasm.batch_markdown_to_html(documents);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function latex_formula_to_mathml(formula) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(formula, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.latex_formula_to_mathml(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function markdown_to_pdf_html(markdown, title) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ret = wasm.markdown_to_pdf_html(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('document_converter_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
